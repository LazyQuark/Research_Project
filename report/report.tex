...
parameters for the signal are obtained from the best template parameters.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth]{../noise_data.png}%
    \includegraphics[width=0.55\textwidth]{../snr_analysis.png}
\end{figure}

I have also did some practical coding to get familiar with the analysis of these gravitaional waves using PyCBC package.
